...
from utils import display_a_file, display_day_name, get_content_of_input, parse_input

result_ex_1 = solve_ex_1(parse_input(get_content_of_input("./input_1.txt")))
result_ex_2 = solve_ex_2(parse_input(get_content_of_input("./input_1.txt")))
